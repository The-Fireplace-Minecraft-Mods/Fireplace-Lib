...
public final class ClothConfigDependencyHandler
{
    ...
    public void addDependency(
        ...
        Supplier<Optional<Component>> configEntryErrorSupplier = ((AbstractConfigEntryAccessor) parent).getErrorSupplier();
        Supplier<Optional<Component>> dependencyCheckingErrorSupplier = addDependencyCheckToErrorSupplier(
            parent,
            child,
    ...
    @Nonnull
    private Supplier<Optional<Component>> addDependencyCheckToErrorSupplier(
        AbstractConfigListEntry<?> parentConfigEntry,
        AbstractConfigListEntry<?> childConfigEntry,
        Predicate<Object> shouldShowChildBasedOnParentValue,
        @Nullable Supplier<Optional<Component>> errorSupplier
    ) {
        return () -> {
