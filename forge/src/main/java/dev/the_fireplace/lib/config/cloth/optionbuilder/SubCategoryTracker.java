...
public final class SubCategoryTracker implements OptionBuilder<Object>
{
    ...
    @Override
    public OptionBuilder<Object> appendCustomDescriptionRow(Component customRow) {
        return null;
    }

    @Override
    public OptionBuilder<Object> setErrorSupplier(Function<Object, Optional<Component>> errorSupplier) {
        return null;
    }
